...
**IP Block**: vyges-ip/fast-fourier-transform-ip  
**Design Version**: 1.0.0  
**Generated On**: 2026-03-27 04:36:45 UTC  
**Author**: Vyges Team  
...
- **OS/Platform**: Linux runnervmrg6be 6.17.0-1008-azure #8~24.04.1-Ubuntu SMP Mon Jan 26 18:35:40 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
...
### Testbench Structure
- **SystemVerilog Testbenches**: tb_fft_top.sv, tb_memory_interface_opt.sv, tb_memory_interface_verilator.sv, tb_simple.sv, tb_twiddle_rom_symmetry.sv, tb_minimal.sv, tb_twiddle_rom.sv, tb_memory_interface_simple.sv, tb_security_validation.sv, tb_example.sv, tb_twiddle_rom_verilator.sv, tb_rescale_unit.sv
- **UVM Testbenches**: None found
- **cocotb Testbenches**: test_fft_basic.py, test_fft_rescaling.py, test_fft_edge_cases.py, test_example.py
...
### Cocotb Simulation
test_fft_basic.py, test_fft_rescaling.py, test_fft_edge_cases.py, test_example.py
