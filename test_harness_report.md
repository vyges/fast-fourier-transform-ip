...
**Generated On**: 2026-05-25 06:15:13 UTC  
**Author**: Vyges Team  
...
- **OS/Platform**: Linux runnervmg397c 6.17.0-1013-azure #13~24.04.1-Ubuntu SMP Wed Apr 15 16:52:17 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
...
- **fft_bus_master.sv**: IP module
- **fft_twiddle_rom.sv**: IP module
- **fft_bin_streamer.sv**: IP module
...
### Testbench Structure
- **SystemVerilog Testbenches**: tb_example.sv, tb_minimal.sv, tb_twiddle_rom.sv, tb_memory_interface_opt.sv, tb_memory_interface_verilator.sv, tb_simple.sv, tb_memory_interface_simple.sv, tb_rescale_unit.sv, tb_security_validation.sv, tb_twiddle_rom_symmetry.sv, tb_fft_top.sv, tb_twiddle_rom_verilator.sv
- **UVM Testbenches**: None found
- **cocotb Testbenches**: test_fft_edge_cases.py, test_fft_rescaling.py, test_example.py, test_fft_basic.py
...
### Cocotb Simulation
test_fft_edge_cases.py, test_fft_rescaling.py, test_example.py, test_fft_basic.py
